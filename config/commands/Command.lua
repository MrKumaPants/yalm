...
command.Help = function(loot, char_settings, global_settings, args)
	...
	Write.Help("\t  \aycreate <name>\ax -- Creates a new command with the given name")
	Write.Help("\t  \aydelete <name>\ax -- Deletes a command with the given name")
...
command.Create = function(loot, char_settings, global_settings, args)
	configuration.create(loot, configuration.types.command.name, args)
end

command.Delete = function(loot, char_settings, global_settings, args)
	configuration.delete(loot, configuration.types.command.name, args)
end
